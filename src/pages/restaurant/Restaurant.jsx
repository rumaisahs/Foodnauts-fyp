...
const Restaurant = () => {
  ...
  const GetSingleRestaurant = async () => {
    let res;
    if (name) {
      res = await getSingleRestaurantByName(name);
    } else {
      res = await getSingleRestaurant(id);
    }
  ...
  const GetSingleReview = async () => {
    const res = await getSingleReview(
      data?.reviews.length > 0 ? data?.reviews[0] : 1
    );
      ...
      <div className="  row justify-content-end">
        <div className="hotelContainer col-10">
          ...
          <div className="p-4 container-lg">
            ...
            {data?.is_verified ? (
              <h6 className="text-primary d-inline ps-2">
                {" "}
                <icon className="bi-patch-check-fill" /> Verified
              </h6>
            ) : (
              ""
            )}
            ...
            <div className="row bg-light mt-3 w-100 mx-auto justify-content-center shadow-sm">
                ...
                <NavLink
                  to={
                    data?.social_links?.length > 0
                      ? data?.social_links[0]?.url
                      : "https://www.google.com/"
                  }
                >
                  <icon className="bi-box-arrow-in-up-left pe-1 fs-5" />
                  <a className=" text-decoration-none text-black fs-5">
                    Website
                  </a>
                </NavLink>
              </button>
              ...
              <button type="button" className="btn col-1 my-2">
                <NavLink
                  to={
                    data?.social_links?.length > 0
                      ? data?.social_links[1]?.url
              ...
              <button type="button" className="btn col-1 my-2">
                <NavLink
                  to={
                    data?.social_links?.length > 0
                      ? data?.social_links[3]?.url
                      : "https://www.foodpanda.pk/"
                  }
                >
                  <Icon
                    icon="simple-icons:foodpanda  "
                    style={{ color: "blue" }}
                  />
                </NavLink>
              </button>
            ...
            <div className="row mt-3 w-100 mx-auto justify-content-between">
              <div className="col-lg-8 bg-light p-4 shadow-sm">
                <div className="row">
                  ...
                  <div className="col-7">
                    ...
                    <h5 className="pt-3">Popular Dishes</h5>
              ...
              <div className="col-lg-4 pt-3 shadow-sm">
                ...
                <span className="justify-content-center d-flex">
                  <iframe
                    className="rounded-4"
                    src={`https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d115837.64059160984!2d${
                      data?.location?.coordinates[1]
                    }!3d${
                      data?.location?.coordinates[0]
                    }!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s${encodeURIComponent(
                      data?.address
                    )}!2s!3m2!1d${data?.location?.coordinates[0]}!2d${
                      data?.location?.coordinates[1]
                    }!5e0!3m2!1sen!2s!4v1698236935806!5m2!1sen!2s`}
                    width="350"
                    height="200"
                    style={{ border: "0" }}
                    allowfullscreen=""
            ...
            <PostForm />
            <h1 className="my-3">
              <icon className="bi-chat-square-dots pe-2" />
              Read Reviews
            </h1>
